...
namespace PremakeExtension
{
	...
	public sealed class RunPremakePackage : AsyncPackage
	{
		/// <summary>
		/// RunPremakePackage GUID string.
		/// </summary>
		public const string PackageGuidString = "e2584306-446b-4a60-bcda-7fd7b5103949";

		/// <summary>
		/// Initializes a new instance of the <see cref="RunPremakePackage"/> class.
		/// </summary>
		...
		protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
		{
		    ...
		    await RunPremake.InitializeAsync(this);
		}
